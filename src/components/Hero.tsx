    ...
    <section className="relative min-h-screen bg-gradient-to-b from-navy-900/95 via-navy-800/90 to-navy-900/95 flex flex-col justify-center overflow-hidden backdrop-blur-3xl transition-opacity duration-500" style={{ opacity: isLoading ? 0 : 1 }}>
      ...
      <div className="container mx-auto px-6 relative z-20">
        <div className="max-w-6xl mx-auto text-left md:text-center">
          ...
          <div className="flex flex-wrap items-center justify-start md:justify-center gap-4 md:gap-8 mt-0">
            <a 
              href="#linkedin" 
              className="text-gray-300 hover:text-violet-300 transition-all duration-300 flex items-center space-x-2 group bg-white/5 backdrop-blur-sm px-4 py-2 rounded-full hover:bg-white/10"
            >
              <Linkedin size={24} strokeWidth={1.5} className="group-hover:scale-110 transition-transform duration-300" />
            ...
            <a 
              ...
              className="text-gray-300 hover:text-violet-300 transition-all duration-300 flex items-center space-x-2 group bg-white/5 backdrop-blur-sm px-4 py-2 rounded-full hover:bg-white/10"
            >
              <svg className="w-6 h-6 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
